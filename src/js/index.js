...
if(month<10){
	currentMonth.textContent = "0"+month+"."+year;
}else{
	currentMonth.textContent = month+"."+year;
}

if(currDay<10){
	currentData.textContent = "0"+currDay+"."+currentMonth.textContent;
}else{
	currentData.textContent = currDay+"."+currentMonth.textContent;
}
